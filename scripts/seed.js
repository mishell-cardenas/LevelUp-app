  ...
  try {
    ...
    await db.collection('games').insertMany([
      ...
      },
      {
        ...
        headerImage: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1086940/header.jpg',
...
const reviewResult = await db.collection('reviews').insertMany([
  { steamId: '1245620', username: 'alex', rating: 5, comment: 'Masterpiece. 200 hours in and still finding new areas.', createdAt: new Date('2024-01-20') },
  { steamId: '1245620', username: 'sam', rating: 4, comment: 'Amazing but brutally difficult. Not for everyone.', createdAt: new Date('2024-01-18') },
  { steamId: '1245620', username: 'jordan', rating: 5, comment: 'Best open world I have ever explored.', createdAt: new Date('2024-02-05') },
  { steamId: '1086940', username: 'jordan', rating: 5, comment: 'Best RPG of the decade. The choices actually matter.', createdAt: new Date('2024-01-12') },
  { steamId: '1086940', username: 'alex', rating: 4, comment: 'Incredible but very long. Set aside 100+ hours.', createdAt: new Date('2024-01-08') },
  { steamId: '413150', username: 'jordan', rating: 5, comment: 'Perfect comfort game. So relaxing.', createdAt: new Date('2023-09-20') },
  { steamId: '413150', username: 'sam', rating: 5, comment: 'Accidentally played until 3am. Multiple times.', createdAt: new Date('2023-08-15') },
  { steamId: '367520', username: 'sam', rating: 5, comment: 'Beautiful, haunting, and incredibly tight gameplay.', createdAt: new Date('2023-07-10') }
]);
console.log(`✅ Created reviews (${reviewResult.insertedCount} documents)`);
    ...
    await db.collection('journal').insertMany([
      ...
      },
      {
        ...
        importantDetails: 'Shadowheart seems suspicious, Gale wants magic items',
    ...
    await db.collection('library').createIndex({ username: 1, steamId: 1 }, { unique: true });
